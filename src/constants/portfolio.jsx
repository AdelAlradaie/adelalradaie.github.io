...
import fullstack from "../assets/lottie/skills/fullstack.json"
import cloudinfra from "../assets/lottie/skills/cloudinfra.json"
...
export const projects = [
    {
        ...
        technologies: [
            { Icon: <SiReact size={20} color="#61DAFB" />, title: 'React' },
            { Icon: <SiLaravel size={20} color='#FF2D20' />, title: 'Laravel' },
            { Icon: <SiWebpack size={20} color="blue" />, title: 'WebPack' },
            { Icon: <SiTailwindcss size={30} color='#38B2AC' />, title: 'Tailwind CSS' },
            { Icon: <SiNpm size={20} color="#CB3837" />, title: 'npm' },
    ...
    },
    {
        ...
        technologies: [
            { Icon: <SiLaravel size={20} color='#FF2D20' />, title: 'Laravel' },
            { Icon: <SiTailwindcss size={20} color='#38B2AC' />, title: 'Tailwind CSS' },
    ...
    },
    {
        ...
        technologies: [
            { Icon: <SiReact size={20} color="#61DAFB" />, title: 'React' },
            { Icon: <SiFirebase size={20} color='#FFCA28' />, title: 'Firebase' },
            { Icon: <SiNpm size={20} color="#CB3837" />, title: 'npm' },
    ...
    },
    {
        ...
        technologies: [
            { Icon: <SiReact size={20} color="#61DAFB" />, title: 'React' },
            { Icon: <SiBootstrap size={20} color='#7952B3' />, title: 'Bootstrap' },
            { Icon: <SiHtml5 size={20} color='#E34F26' />, title: 'HTML5' },
            { Icon: <SiCss3 size={20} color='#1572B6' />, title: 'CSS3' },
    ...
    },
    {
        ...
        technologies: [
            { Icon: <SiReact size={20} color="#61DAFB" />, title: 'React' },
            { Icon: <SiMongodb size={20} color='#47A248' />, title: 'MongoDB' },
            { Icon: <SiNodedotjs size={20} color='#339933' />, title: 'Node.js' },
            { Icon: <SiFirebase size={20} color='#FFCA28' />, title: 'Firebase' },
            { Icon: <SiTailwindcss size={20} color='#38B2AC' />, title: 'Tailwind CSS' },
